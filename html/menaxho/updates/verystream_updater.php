...
/*----------------------------------KODI PER OPENLOAD--------------------------------------*/
echo "<p> LINKET E Verystream </p><br>";
$file_name="verystream_links.txt";	//Emri i file-it
...
for($i=0; $i<count($data_array); $i++)
{
	...
	$query="UPDATE `$Indeksi` SET `Stream_3` =  '$Stream_link' WHERE  `Episodi` = '$Episodi' ";
	//Kodi per pjesen
