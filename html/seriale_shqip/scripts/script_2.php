...
if(isset($_GET["Indeksi"]))
{
	...
	$outer_query="SELECT * FROM `Main` WHERE `Indeksi`='$Indeksi'";
	...
	if(isset($_GET["Window"]))
	{
		...
		{	
			...
			{	        
			    ...
			    $LinkHref="/uni/find_stream.php?SoF=S&Kategoria=$outer_row[Kategoria]&Indeksi=$Indeksi&Episodi=$row[Episodi]"; 
