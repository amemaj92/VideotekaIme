...
<html lang="sq">
	...
	<meta name="google-site-verification" content="vQNgebVB6M2uVLflLXOWFPuMrGZQWGC2k3hYpU6Fk9o" />
    </head>
    ...
    <body>	    
	    ...
	    <div id="tutorial_and_videos_section">
	        ...
	        <div id="video_container">
	        	<video id="tutoriali" controls oncontextmenu="return false;">
			        	<source src="http://videotekaime.net/Desktop_Tutorial.mp4" type="video/mp4">
			    </video>
	        </div>
	        </div>
	    </div>
	...
	<div id="content">
	   ...
	   <div id="right_col_text_div">	
		...
		<ul id="lista_seriale">
		    <?php 
			$query="SELECT * FROM `Main` ORDER BY `Data_Perditesimit` DESC, `Rendi` DESC LIMIT 24"; 
			...
			while($row=mysqli_fetch_assoc($result)) {
			    ...
			    $anchor_href="/seriale_shqip/skeda/$row[Indeksi]$row[Dubluar_Titruar]";
	    ...
	    <div id="new_movies">
	        ...
	        <?php 
	            ...
	            while ($row=mysqli_fetch_array($result)) {
	            	if($row[0]=="turkish_movies") continue;
			...
			$anchor_href="/filma_shqip/skeda/$inner_row[Burimi]/$inner_row[Indeksi]"; 
