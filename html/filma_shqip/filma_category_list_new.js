var List_Manager = 
{
	...
	{		
		/*--------------------LISTA SERIALE-------------------*/
		List_Manager.lista=document.getElementById("lista_filmave_1");
		List_Manager.Height_Setting();
		List_Manager.lista=document.getElementById("lista_filmave_2");
		List_Manager.Height_Setting();
	},
	...
	Height_Setting: function()
	{
		...
		var i=0; 
		max_height=0;
		var p_height, calculated_img_height, temp_max_height, padding_correction;			
...
var Sort_Form_Manager = 
{
	...
	Submit_Rewrite: function(event)
	{
		...
		{
		    var current_url="/filma_shqip/"+ct;
...
var CheckboxSubcategoriesMenager =
{
	init: function()
	{
		...
		Core.addEventListener(CheckboxSubcategoriesMenager.formulari.getElementsByTagName("ul")[1], "click", CheckboxSubcategoriesMenager.ClickManager);
