     		...
     		<?php if(abonimi_ne_skadim($_SESSION["user_id"],$_SESSION["username"]) == true): ?> 
	 	     ...
	 	     <h2>Bli Kredite</h2>
		 	     <form action="" method="GET" id="formulari_abonimit">
			         <input type=radio value="1muaj" name="abonimi" checked id="abonimi_1_muaj">1 Muaj (600 Kredite per $5.00)<br>
				 <input type=radio value="6muaj" name="abonimi" id="abonimi_6_muaj">6 Muaj (3600 Kredite per $25.00)<br>
				 <input type=radio value="12muaj" name="abonimi" id="abonimi_12_muaj">12 Muaj (7200 Kredite per $50.00)<br>
			     </form>
			    ...
			    <script>
					...
					if(document.getElementById("abonimi_1_muaj").checked == true)
					{
			                ...
			                else if(document.getElementById("abonimi_6_muaj").checked == true)
			                {
			                			                // Make a call to the REST api to create the payment
				                return actions.payment.create({
				                    payment: {
			                ...
			                else if(document.getElementById("abonimi_12_muaj").checked == true)
			                {
			                			                // Make a call to the REST api to create the payment
				                return actions.payment.create({
				                    payment: {
			            ...
			            onAuthorize: function(data, actions) {
			                ...
			                return actions.payment.execute().then(function() {
			                    if(document.getElementById("abonimi_1_muaj").checked == true) videoteka_abonimi_pagesa=5.00;
			                    else if(document.getElementById("abonimi_6_muaj").checked == true) videoteka_abonimi_pagesa=25.00;
			                    else if(document.getElementById("abonimi_12_muaj").checked == true) videoteka_abonimi_pagesa=50.00;
