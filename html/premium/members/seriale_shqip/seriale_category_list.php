...
<html lang="sq">
	...
	<link rel="stylesheet" type="text/css" href="/premium/members/seriale_shqip/seriale_category_list_style.css">
	<!-- +++ Own Scripts +++ -->
	...
	<script type="text/javascript" src="/premium/members/seriale_shqip/seriale_category_list.js"></script>
	...
	<div id="content">
		...
		<div id="simple_search_form">
			...
			<form  action="/premium/members/seriale_shqip/'.$ct.'/'.$Sort.'" method="POST">
		...
		echo '<form action="/premium/members/seriale_shqip/'.$ct.'/'.$Sort.'" method="POST"> <input type="hidden" name="Req_Type" value="subcategories_filter">';		
		...
		<a href="/premium/members/seriale_shqip/'.$ct.'">Anulo</a></div></form></div>';

	  	echo '<ul id="lista_seriale">';

		//Scripti qe gjeneron listen e serialeve.
		$incl_return=include('/var/www/protected_scripts/series_list_and_search_script_premium.php');
		...
		if($Window%5==0) $window_range=intval($Window/5);
	 	...
	 	if($window_range>1) echo '/premium/members/seriale_shqip/'.$ct.'/'.(($window_range-1)*5).'">';
	 	...
	 	else {echo '/premium/members/seriale_shqip/'.$ct.'/'.$Sort.'/'.((($window_range-1)*5)+1).'"'; if(((($window_range-1)*5)+1)==$Window) echo ' class="current"';}
	 	echo '>'.((($window_range-1)*5)+1).'</a></li>
	 	
	 	<li><a href="';
	 	//Check if window is within range
	 	if(((($window_range-1)*5)+2)>$num_windows) echo '#" class="greyed"';
	 	else {echo '/premium/members/seriale_shqip/'.$ct.'/'.$Sort.'/'.((($window_range-1)*5)+2).'"'; if(((($window_range-1)*5)+2)==$Window) echo ' class="current"';}
	 	echo '>'.((($window_range-1)*5)+2).'</a></li>
	 	
	 	<li><a href="';
	 	//Check if window is within range
	 	if(((($window_range-1)*5)+3)>$num_windows) echo '#" class="greyed"';
	 	else {echo '/premium/members/seriale_shqip/'.$ct.'/'.$Sort.'/'.((($window_range-1)*5)+3).'"'; if(((($window_range-1)*5)+3)==$Window) echo ' class="current"';}
	 	echo '>'.((($window_range-1)*5)+3).'</a></li>
	 	
	 	<li><a href="';
	 	//Check if window is within range
	 	if(((($window_range-1)*5)+4)>$num_windows) echo '#" class="greyed"';
	 	else {echo '/premium/members/seriale_shqip/'.$ct.'/'.$Sort.'/'.((($window_range-1)*5)+4).'"'; if(((($window_range-1)*5)+4)==$Window) echo ' class="current"';}
	 	echo '>'.((($window_range-1)*5)+4).'</a></li>
	 	
	 	<li><a href="';
	 	//Check if window is within range
	 	if(((($window_range-1)*5)+5)>$num_windows) echo '#" class="greyed"';
	 	else {echo '/premium/members/seriale_shqip/'.$ct.'/'.$Sort.'/'.((($window_range-1)*5)+5).'"'; if(((($window_range-1)*5)+5)==$Window) echo ' class="current"';}
	 	echo '">'.((($window_range-1)*5)+5).'</a></li>
	 	
	 	<li><a href="';
	 	//Check if window is within range
	 	if(((($window_range-1)*5)+6)>$num_windows) echo '#" class="greyed"';
	 	else echo '/premium/members/seriale_shqip/'.$ct.'/'.$Sort.'/'.((($window_range-1)*5)+6);
	 	echo '">&gt;&gt;</a></li>
