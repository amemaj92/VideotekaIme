...
<html lang="sq">
    ...
    <?php if(login_check($mysqli) == true): ?>	    
		...
		<div id="abonimi">
		  <h1>Abonohu: <span>6 Muaj per $25</span></h1>
		  <p>Nese je i/e interesuar na kontakto ne: <span>videotekaime@gmail.com</span></p>
		</div>
	   </div>     
